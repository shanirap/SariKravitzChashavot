      ...
      <div className="card mb-4">
        ...
        <div className="card-body">
          <div className="alert alert-info py-2 mb-3" style={{ fontSize: '0.88rem' }}>
            ...
            {employerId ? (
              <>העובדים יתווספו אוטומטית למעסיק <strong>{employer?.name || ''}</strong>. כל שורה חייבת לכלול <strong>תז</strong> ו-<strong>שנת_לימודים</strong>.</>
            ) : (
              <>כל שורה חייבת לכלול <strong>שם_מעסיק</strong> תואם למעסיק קיים במערכת, <strong>תז</strong> ו-<strong>שנת_לימודים</strong>.</>
            )}
