      ...
      <div className="card mb-4">
        ...
        <div className="card-body">
          <div className="alert alert-info py-2 mb-3" style={{ fontSize: '0.88rem' }}>
            ...
            {employerId ? (
            <>העובדים יתווספו אוטומטית למעסיק <strong>{employer?.name || ''}</strong>. כל שורה חייבת לכלול <strong>תז</strong> ו-<strong>שנת_לימודים</strong>. שדות מחושבים (סה״כ, אחוז משרה, תוספת אם, קרן השתלמות, שעות גיל ושעות מחנך/גננת) מחושבים מחדש בשרת ואינם נלקחים מהקובץ. שדות אופציונליים כוללים <strong>מספר_עובד_בעוקץ</strong>, טלפון ותאריכי לידה של ילדים — כמו בטופס הוספת עובד.</>
            ) : (
              <>כל שורה חייבת לכלול <strong>שם_מעסיק</strong> תואם למעסיק קיים במערכת, <strong>תז</strong> ו-<strong>שנת_לימודים</strong>. שדות מחושבים (סה״כ, אחוז משרה, תוספת אם, קרן השתלמות, שעות גיל ושעות מחנך/גננת) מחושבים מחדש בשרת. ניתן למלא גם <strong>מספר_עובד_בעוקץ</strong> ושאר פרטי העובד לפי התבנית.</>
            )}
